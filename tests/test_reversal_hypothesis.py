...
class ReversalHypothesisTests(unittest.TestCase):
    ...
    def test_classifies_selected_minute_persistent_reversal(self) -> None:
        ...
        self.assertEqual(len(minute_30["samples"]), 1)
        self.assertEqual(minute_30["samples"][0]["entry_price"], 102.0)
        self.assertFalse(minute_30["samples"][0]["reversal_1"])
        self.assertTrue(minute_30["samples"][0]["reversal_5"])
